...
public class SpeedRunnerV2 {
    private final String dirName = "newCases/inputs/"; // this is the directory of the inputs
    private final String realName = "newCases/outputs/"; // this is the directory of the outputs that you want to compare
